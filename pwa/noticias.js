...
// Inicializar el sistema de noticias cuando los componentes dinámicos estén listos
...
// Respaldo por si se carga de forma síncrona en alguna página antigua
document.addEventListener('DOMContentLoaded', function() {
  if (!window.noticiasManager && document.querySelector('.news-container')) {
    window.noticiasManager = new NoticiasManager();
  }
});
